...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 group-hover:pointer-events-auto z-20">
      {href && cta && cta.trim() !== "" && (
        <Button
          variant="ghost"
          asChild
          size="sm"
          className={cn(
            "pointer-events-auto whitespace-nowrap transition-colors duration-300 bg-white",
